          ...
          <tbody>
            @foreach($transaction as $key => $value)
              <tr>
                ...
                <td> <i class="fa fa-money"></i> {{ $value->subtotal }}</td>
                <td> <i class="fa fa-money"></i> {{ $value->payment }}</td>
                <td> <i class="fa fa-money"></i> {{ $value->balance }}</td>
                <td> <i class="fa fa-money"></i> {{ $value->due }}</td>
              </tr>
            @endforeach
          </tbody>
        </table>
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              ...
              <td> <i class="fa fa-money"></i> {{ $total['purchase'] }}</td>
            </tr>
            <tr>
              <th>Paid Amount:</th>
              <td> <i class="fa fa-money"></i> {{ $total['payment'] }}</td>
            </tr>
            <tr>
              <th>Balance Amount:</th>
              <td> <i class="fa fa-money"></i> {{ $total['balance'] }}</td>
            </tr>
            <tr>
              <th>Due Amount:</th>
              <td> <i class="fa fa-money"></i> {{ $total['due'] }}</td>
            </tr>
          </table>
        </div>
      </div>
