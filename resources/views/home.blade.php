 ...
 <section>
    <div class="col-md-12">
        <div class="col-md-4 pull-left">
            <div class="box box-info">
            <div class="box-header with-bstock_category">
              <h3 class="box-title">Trending Item</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove">
   ...
   <div class="row" style="width:99%;margin-left:5px">
                      <div class="col-xs-12">
                        <table id="table" class="table table-responsive" 
                               ...
                               data-sort-name="trending_item_id"
                               data-sort-order="desc">
                            <thead>
                            <tr>
                                 <th data-field="trending_item_id" data-align="center" data-sortable="true">ID</th>
                                <th data-field="sold_quantity" data-align="center" data-sortable="true">Sold Quantity</th>
   ...
   <div class="row" style="width:99%;margin-left:5px">
                      <div class="col-xs-12">
                        <table id="table" class="table table-responsive" 
                            ...
                            <thead>
                            <tr>
                               <th data-field="product_goal_id" data-align="center" data-sortable="true">ID</th>
